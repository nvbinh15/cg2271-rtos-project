...
//int tones[7] = {100, 400, 100, 400, 100, 1000, 3200};
...
//	SystemCoreClockUpdate();
	...
	while (1) {
		/*
		if (count == sizeof(nyanCatMelody) / 4 ) {
			count = 0;
		}
		
		if (nyanCatMelody[count] != 0) {
			TPM1->MOD = 375000 / nyanCatMelody[count];
			TPM1_C1V =  375000 / nyanCatMelody[count] / 10;
		}
		*/
		if (count == sizeof(melody) / 4 ) {
			count = 0;
		}
		
		if (melody[count] != 0) {
			TPM1->MOD = 375000 / melody[count];
			TPM1_C1V =  375000 / melody[count] / 10;
		}
